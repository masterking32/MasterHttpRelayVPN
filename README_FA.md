...
<small>این برنامه کاملاً پرتابل و سریع است و به هیچ پیش‌نیاز، نصب یا تنظیمات خاصی احتیاج ندارد.<br>برای توضیحات بیشتر و راهنمای کامل به مخزن [MasterHttpRelayVPN](https://github.com/AriPath/MasterVPN) مراجعه کنید.<br>فایل‌های برنامه در دایرکتوری [`Windows App`](./Windows%20App/) همین پروژه در دسترس قرار دارند.</small>
---
