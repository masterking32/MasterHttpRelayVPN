...
این برنامه کاملاً پرتابل و سریع است و به هیچ پیش‌نیاز، نصب یا تنظیمات خاصی احتیاج ندارد.<br>
برای توضیحات بیشتر و راهنمای کامل به مخزن <a href="https://github.com/AriPath/MasterVPN">MasterHttpRelayVPN</a> مراجعه کنید.<br>
فایل‌های برنامه در دایرکتوری <code>Windows App</code> همین پروژه در دسترس قرار دارند.
