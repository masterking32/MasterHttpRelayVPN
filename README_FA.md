...
این برنامه کاملاً پرتابل و سریع است و به هیچ پیش‌نیاز، نصب یا تنظیمات خاصی احتیاج ندارد. برای توضیحات بیشتر و راهنمای کامل به مخزن <a href="https://github.com/AriPath/MasterVPN"><strong>MasterHttpRelayVPN</strong></a> مراجعه کنید. فایل‌های برنامه در دایرکتوری <strong><code>Windows App</code></strong> همین پروژه در دسترس قرار دارند.
